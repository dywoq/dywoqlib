...
DYWOQLIB_EXPORTED_FROM_ABI
source::source(const char *__file_name, const char *__function,
               const char *__pretty_function, int __line) noexcept
    : __file_name_(__file_name), __function_(__function),
      __pretty_function_(__pretty_function), __line_(__line) {
}
...
DYWOQLIB_EXPORTED_FROM_ABI const char *
source::pretty_function() const noexcept {
  return __pretty_function_;
}
