...
//
#ifndef DYWOQLIB_CONSTRAINTS_UNION_HXX
#define DYWOQLIB_CONSTRAINTS_UNION_HXX
...
struct union_constraint
    : public is_constraint_valid<__implementation::is_union<_Tp>()> {};

template <typename _Tp>
concept union_c = union_constraint<_Tp>::status;
